...
namespace CoronelExpress.Controllers.Admin
{
    ...
    public class QuejasSugerenciasController : Controller
    {
        ...
        // GET: Admin/QuejasSugerencias
        public IActionResult Index()
        {
            var mensajes = _context.QuejaSugerenciaMessages
                                   .OrderByDescending(m => m.Fecha)
                                   .ToList();
            return View(mensajes);
        }

        // GET: Admin/QuejasSugerencias/Details/5
        public IActionResult Details(int id)
        {
            var mensaje = _context.QuejaSugerenciaMessages.FirstOrDefault(m => m.Id == id);
            if (mensaje == null)
            {
                return NotFound();
            }
        ...
        // GET: Admin/QuejasSugerencias/Reply/5
        ...
        // POST: Admin/QuejasSugerencias/Reply
        [HttpPost]
        public async Task<IActionResult> Reply(ReplyViewModel model)
        {
            ...
            try
            {
                // Configuración del cliente SMTP con liberación automática de recursos
                using (var smtpClient = new SmtpClient("smtp.gmail.com"))
                {
                    ...
                    using (var mailMessage = new MailMessage())
                    {
                        ...
                        mailMessage.Subject = "Respuesta a su Queja o Sugerencia";
                        mailMessage.IsBodyHtml = true;

                        // Construir el cuerpo del correo con HTML y CSS inline para un diseño profesional
                        ...
                        body.AppendLine("    <title>Respuesta a su Queja o Sugerencia</title>");
                        ...
                        body.AppendLine("            <h2>Respuesta a su Queja o Sugerencia</h2>");
                        body.AppendLine("            <p>Estimado(a) Cliente,</p>");
                        body.AppendLine("            <p>Hemos revisado detenidamente su queja o sugerencia y a continuación le presentamos nuestra respuesta:</p>");
                        body.AppendLine("            <div class='blockquote'>");
                        body.AppendLine("                " + model.Message);
                        body.AppendLine("            </div>");
                        body.AppendLine("            <p>Si requiere mayor información o desea comunicarse nuevamente, estamos a su disposición.</p>");
        ...
        // POST: Admin/QuejasSugerencias/Delete/5
        [HttpPost]
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (mensaje != null)
            {
                _context.QuejaSugerenciaMessages.Remove(mensaje);
